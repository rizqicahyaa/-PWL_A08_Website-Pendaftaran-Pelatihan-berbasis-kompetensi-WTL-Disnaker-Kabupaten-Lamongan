                        ...
                        <div class="basic-tb-hd">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <h2>Data Peserta Lulus Pelatihan</h2>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($pendaftaran as $no => $p)
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-teal teal-icon-notika"
                                                    title="Detail Berkas" data-toggle="modal" data-target="#myModaltwo{{ $p->id }}">
                                                    <i class="notika-icon notika-file"></i></button>
                                                <a href="/admin/pesertalulus/edit{{ $p->id }}"><button
                                                        class="btn btn-primary primary-icon-notika" data-toggle="tooltip"
                                                        data-placement="top" title="Edit"><i
                                                            class="notika-icon notika-edit"></i></button></a>
                                                <a href="/admin/pesertalulus/hapus{{ $p->id }}"><button class="btn btn-danger danger-icon-notika"
