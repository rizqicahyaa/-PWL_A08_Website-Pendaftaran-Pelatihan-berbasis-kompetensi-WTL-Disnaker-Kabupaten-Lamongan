            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6"
                        ...
                        <p class="mb-40"><a href="/">
                                < Kembali</a>
                        </p>
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="h2 section-title text-center text-dark">DAFTAR</p>
                            </div>
                        </div>
                        {{-- @if ($errors->any())
                        ...
                        @endif --}}
                        <form action="{{ route('daftar-proses') }}" method="POST" class="row justify-content-center">
                            @csrf
                            <div class="col-lg-10 mb-30">
                                <label>
                                    <p class="h5 text-dark">Nama Lengkap</p>
                                </label>
